...
public class ActivityManager {
    ...
    public static final String ACTIVITY_MANAGER_MESSAGE = "activity_manager_message";
    ...
    @Subscriber(tag = ACTIVITY_MANAGER_MESSAGE, mode = ThreadMode.MAIN)
    ...
    public void removeActivity(Activity activity) {
        if (mActivityList == null) {
            Logger.d("mActivityList == null when removeActivity(Activity)");
            return;
        }
        synchronized (ActivityManager.class) {
            if (mActivityList.contains(activity)) {
    ...
    public void AppExit() {
        try {
            ...
            android.app.ActivityManager activityMgr =
                    (android.app.ActivityManager) mApplication.getSystemService(Context
                            .ACTIVITY_SERVICE);
